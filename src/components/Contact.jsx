  ...
  return (
    <div id='contact' className='my-20 min-h-96 w-screen px-10'>
        ...
        text-blue-50 sm:overflow-hidden '>
            ...
            <div className='absolute -top-20 left-20  w-60 sm:top-1/2 md:left-auto md:right-10
            lg:top-20 lg:w-80 '>
            ...
            <div className='flex flex-col items-center text-center'>
                ...
                <p className='special-font mt-10 font-zentry w-full text-5xl leading-[0.9] md:text-[6rem]'>
                Let's build the <br /> new era of <br /> g<b>a</b>ming t<b>o</b>gether
                </p>
